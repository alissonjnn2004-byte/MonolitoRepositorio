        ...
        <div class="glass-container">
            ...
            <div class="form-grid">
                ...
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtNombres" runat="server" CssClass="input-control" placeholder="Ej: Juan Carlos" onkeypress="return soloLetras(event)"></asp:TextBox>
                ...
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtApellidos" runat="server" CssClass="input-control" placeholder="Ej: Pérez García" onkeypress="return soloLetras(event)"></asp:TextBox>
                ...
                <script type="text/javascript">
                    ...
                    // Agregamos el evento al botón de "Ver Fotos" y "Registrar"
                    window.onload = function () {
                        var btnPreview = document.getElementById('<%= btnSubirPreview.ClientID %>');
                        var btnReg = document.getElementById('<%= btn_Registrar.ClientID %>');

                        btnPreview.onclick = function () { return validarArchivosAntesDeSubir(); };
                        btnReg.onclick = function () { return validarArchivosAntesDeSubir(); };
                    };
                </script>

                <asp:Button ID="btn_Registrar" runat="server" Text="REGISTRAR USUARIO" CssClass="register-btn" OnClick="btn_Registrar_Click" />
            </div>
